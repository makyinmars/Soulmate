    ...
    <>
      ...
      <Menu>
        <div className="flex flex-col items-center gap-4 custom-container">
          ...
          <button className="custom-button text-base md:text-lg">Choose a custom picture</button>
          <button className="custom-button text-base md:text-lg">Choose from default pictures</button>
